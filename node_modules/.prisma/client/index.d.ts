...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'adminUser' | 'blog' | 'blogCategory' | 'blogUniversity' | 'blogUniversityDepartment' | 'grade' | 'grammar' | 'grammarQuestion' | 'log' | 'product' | 'productReview' | 'oneTimePassword' | 'stripeCheckout' | 'stripeCustomer' | 'user'
  ...
  export type GrammarQuestionWhereInput = {
    ...
    question?: JsonNullableFilter<"GrammarQuestion">
  ...
  export type GrammarQuestionScalarWhereWithAggregatesInput = {
    ...
    question?: JsonNullableWithAggregatesFilter<"GrammarQuestion">
